            ...
            <div className="flex items-center space-x-3 text-right flex-1 justify-end">
              <div>
                ...
                <p className="text-xs font-mono text-sky-400">
                  Local • #{match.homeTeam.position} ({match.homeTeam.points} pts)
                </p>
              </div>
            ...
            <div className="flex items-center space-x-3 text-left flex-1 justify-start">
              ...
              <div>
                ...
                <p className="text-xs font-mono text-indigo-400">
                  Visita • #{match.awayTeam.position} ({match.awayTeam.points} pts)
                </p>
              </div>
            </div>
                    ...
                    <button
                      onClick={() => {
                        ...
                        onAddToParlay({
                          ...
                          selection: aiReport?.topPick?.selection || match.aiPick.selection,
                          odds: aiReport?.topPick?.odds || match.aiPick.odds,
                    ...
                    <button
                      onClick={() => {
                        ...
                        onAddToParlay({
                          ...
                          probability: match.probabilities.bttsYes
                        });
                      }}
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px] text-slate-300">
                    <span className="font-bold text-sky-400">
                      {match.homeTeam.name}: {homeWins} ({h2hHomeWinPct}%)
                    </span>
                    <span className="text-slate-400">
                      Empates: {draws} ({h2hDrawPct}%)
                    </span>
                    <span className="font-bold text-indigo-400">
                      {match.awayTeam.name}: {awayWins} ({h2hAwayWinPct}%)
                    </span>
                  </div>
              ...
              <div className="bg-[#111723] rounded-xl p-4 border border-white/5">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-mono text-sky-400">
                    Promedio: {(match.homeTeam.avgCorners + match.awayTeam.avgCorners).toFixed(1)} / partido
                  </span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 font-mono text-xs">
                  <div className="bg-[#141b29] p-3 rounded-lg border border-white/5 text-center">
                    <span className="text-slate-400 block mb-0.5">Corners {match.homeTeam.shortName} (Local)</span>
                    <span className="text-lg font-bold text-sky-400">{match.homeTeam.avgCorners}</span>
                  </div>
                  <div className="bg-[#141b29] p-3 rounded-lg border border-white/5 text-center">
                    <span className="text-slate-400 block mb-0.5">Corners {match.awayTeam.shortName} (Visita)</span>
                    <span className="text-lg font-bold text-indigo-400">{match.awayTeam.avgCorners}</span>
                  </div>
                  <div className="bg-[#141b29] p-3 rounded-lg border border-white/5 text-center">
